...
<head>
    <meta charset="utf-8">
    <title>MOTOMIN - Form Kategori</title>
    ...
    <div class="container-fluid position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="../kategori.php" class="nav-item nav-link active"><i class="fas fa-shopping-basket"></i> Category</a> <!--tipe motor-->
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                ...
                <h3 class="text-secondary"> Form Kategori </h3>
