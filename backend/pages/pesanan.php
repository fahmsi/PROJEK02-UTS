...
<head>
    <meta charset="utf-8">
    <title>MOTOMIN - Order List</title>
...
<body>
    <div class="container-fluid position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="produk.php" class="nav-item nav-link"><i class="fa-solid fa-shop"></i> Product</a> <!--motor-->
                    ...
                    <a href="pesanan.php" class="nav-item nav-link active"><i class="fas fa-receipt"></i> Order List</a> <!--pesanan-->
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
        ...
        <div class="content">
            ...
            ?>
            <br>
            <a class="btn btn-primary" href="../pages/form/form_pesanan.php" role="button">Add Order <i class="fa fa-cart-plus" aria-hidden="true"></i></a><br><br>
                ...
                <tbody>
                    ...
                    ?>
                            <tr >
                                ...
                                <td><?=$row['quantity']?></td>
                                <td>
                                <button type="button" class="btn btn-square btn-outline-success m-2"><a href="../progress/review/pesanan.php?id=<?= $row['id'] ?>"><i class="fa fa-eye" aria-hidden="true"></i></a></button>
                                <button type="button" class="btn btn-square btn-outline-secondary m-2"><a href="../progress/update/edit_pesanan.php?idedit=<?= $row['id'] ?>"><i class="fa fa-pencil" aria-hidden="true"></i></a></button>
                                <button type="button" class="btn btn-square btn-outline-danger m-2"><a href="../../backend/progress/delete/delete_pesanan.php?iddel=<?=$row['id']?>"
                                onclick="if(!confirm('Anda Yakin Hapus Data Pesanan <?=$row['nama_pelanggan']?>?')) {return false}"><i class="fa fa-trash" aria-hidden="true"></i></a></button>
                                </td>
                            </tr>
                        <?php 
                        $nomor++;   
