...
<head>
    <meta charset="utf-8">
    <title>MOTOMIN - Update Pesanan</title>
    ...
    <div class="container-fluid position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                ...
                <h3 class="text-secondary"> Update Pesanan </h3>
                ...
                <form method="POST" action="../../progress/process/proses_pesanan.php">
                    ...
                    <label for="alamat_pelanggan" class="col-4 col-form-label">Alamat Pelanggan</label> 
                        <div class="col-8">
                            <div class="input-group">
                                <input id="alamat_pelanggan" name="alamat_pelanggan" value="" type="text" class="form-control">
                            </div>
                        </div>
                    </div><br>
                    <div class="form-group row">
                    <label for="motor_id" class="col-4 col-form-label">Produk Motor</label> 
                        <div class="col-8">
                            ...
                            <select id="motor_id" name="motor_id" class="form-select">
                                ...
                                ?>
                                    <option value="<?=$rowtipe['id']?>"><?=$rowtipe['nama_motor']?></option>
                                <?php
                                    }
                                ?>
                            </select>
                    ...
                    <div class="form-group row">
                    <label for="quantity" class="col-4 col-form-label">Kuantitas</label> 
                        <div class="col-8">
                            <div class="input-group">
