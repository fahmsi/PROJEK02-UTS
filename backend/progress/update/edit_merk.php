...
<head>
    <meta charset="utf-8">
    <title>MOTOMIN - Update Merk</title>
    ...
    <div class="container-fluid position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="../merk.php" class="nav-item nav-link active"><i class="fas fa-tags"></i> Merk</a> <!--merk-->
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                ...
                <h3 class="text-secondary"> Form Merk </h3>
                <?php 
                ...
                ?>
                <form method="POST" action="../../progress/process/proses_merk.php">
                    <input type="hidden" name="idedit" value="<?= $result['id'] ?>">
                    <div class="form-group row">
                    <label for="id" class="col-4 col-form-label">ID</label> 
                        <div class="col-8">
                            <div class="input-group">
                                <input id="" name="id" type="number" class="form-control" value="">
                            </div>
                        </div>
                    </div><br>
                    <div class="form-group row">
                    <label for="nama_motor" class="col-4 col-form-label">Nama Merk Motor</label> 
                        <div class="col-8">
                            <div class="input-group"> 
                                <input id="" name="nama_motor" type="text" class="form-control" value="">
                            </div>
                        </div>
                    </div><br>
                    <div class="form-group row">
