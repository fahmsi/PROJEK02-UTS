...
<head>
    <meta charset="utf-8">
    <title>MOTOMIN - View Category</title>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="../../pages/kategori.php" class="nav-item nav-link active"><i class="fa-solid fa-shop"></i> Category</a> <!--motor-->
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
            ...
            <div class="container-fluid pt-4 px-4">
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="../../pages/kategori.php">Category</a>
                        </li>
                ...
                <h3 class="text-secondary"> Review Category </h3>
                ...
                <table class="table table-hover table-striped">
                    <tbody>
                        ...
                        <tr>   <td>type Motor</td><td><?=$row['tipe_motor']?></td></tr>
                    </tbody>
                </table>
            </div>
