...
<head>
    <meta charset="utf-8">
    <title>MOTOMIN - View Order List</title>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="../../pages/pesanan.php" class="nav-item nav-link active"><i class="fa-solid fa-shop"></i> Order List</a> <!--motor-->
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
            ...
            <div class="container-fluid pt-4 px-4">
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">
                            <a href="../../pages/pesanan.php">Order List</a>
                        </li>
                ...
                <h3 class="text-secondary"> Review Order List </h3>
                ...
                <table class="table table-hover table-striped">
                    <tbody>
                        ...
                        <tr>   <td>Nama Pemesan</td><td><?=$row['nama_pelanggan']?></td></tr>
                        <tr>   <td>Alamat Pemesan</td><td><?=$row['alamat_pelanggan']?></td></tr>
                        <tr>   <td>Produk Motor</td><td><?=$row['motor_id']?></td></tr>
                        <tr>   <td>Kuantitas</td><td><?=$row['quantity']?></td></tr>
                    </tbody>
                </table>
            </div>
